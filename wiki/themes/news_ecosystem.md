...
temporal_scope: "Particularly attentive to the 2020+ period as news-creator cohort matures"
...
> Temporal scoping is mandatory: news on YouTube has shifted
> meaningfully over the past five years.
...
is functioning as a news platform in 2024-2025, while Wu and
Resnick add peer-reviewed evidence about what ideological
interaction looks like inside one important public-affairs
comment space on the platform. [🤖]

*[Note: peer-reviewed coverage is no longer empty, but the theme
still remains thin and uneven across countries and methods.]* [🤖]

## Current Consensus

- Political YouTube is not a pure comment-layer echo chamber: Wu and Resnick find substantial cross-partisan discussion on U.S. partisan channels, although it is asymmetric and often not especially civil. [🤖]
...
|-------|--------|----------|----------|--------|----------|
| Cross-partisan political discussion on YouTube comments is common but asymmetric, with conservatives more likely to comment across ideological lines. | Wu and Resnick 2021 | 973-channel U.S. partisan-media comment dataset plus user-leaning classification | single-source | Jan.-Aug. 2020 | [🤖] |
...
- The three sources observe different layers of the ecosystem:
  Wu and Resnick analyze comment interaction on U.S. partisan
  channels, whereas Newman and Reuters are audience-side survey
  projects. [🤖]
- Wu and Resnick infer user ideology from comment text,
  subscriptions, and shared entities, which measures active
  discussion publics rather than the broader audience or the
...
- Newman relies on open-text creator naming and manual typology
  ...
  markets. [🤖]
- All three sources face boundary problems, but at different levels:
  Wu and Resnick classify partisan channels and commenters,
  Newman classifies creator types, and Reuters separates creators
  from personalities while acknowledging overlap. [🤖]

## Measures and Variables Used in the Literature

The current evidence base uses comment counts, commenter overlap,
user-leaning predictions, top-comment visibility, toxicity scores,
open-text mentions of creators and brands, creator categories,
follower counts, gender balance, platform-specific news use, where
users pay attention on specific networks, preferred news modality,
misinformation concern, and verification practices. [🤖]
...
- Wu and Resnick illuminate the discussion layer, but the current
  corpus still cannot tell us how recommendations, subscriptions,
  and actual viewing histories jointly shape news exposure. [🤖]
