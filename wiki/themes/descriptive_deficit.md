...
- YouTube remains understudied relative to its scale and public
  ...
  2024, pp. 3-5). [🤖]
- YouTube's own commissioned impact report underscores the scale side
  of the denominator problem without solving it: the company says the
  platform hosts more than 20 billion videos, receives more than 20
