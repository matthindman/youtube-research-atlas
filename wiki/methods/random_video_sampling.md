...
1. **Zhou, Li, Adhikari, & Zhang (2011)**, "Counting YouTube videos via
   random prefix sampling." The foundational RPS paper. McGrady et al.
   rely on it as the method origin. Essential for any methods-companion
   claim about RPS statistical properties.
2. **Zheng, McGrady, & Zuckerman (2024), TubeStats.** Source of the
...
3. **Rieder, Padilla, & Coromina (2025), "Forgetful by design?"** A
...
4. **Karkulahti & Kangasharju (2015)**, "YouTube Revisited." Makes
...
- **Papers that use this method:** [[golnari_et_al_2014]], [[mcgrady_2023]], [[mcgrady_2025]], [[bartl_2018]]
