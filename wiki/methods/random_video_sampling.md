...
or related designs (e.g., Golnari et al. 2014, Akgul et al. 2022,
Zheng et al. 2024) are referenced in the McGrady papers but are not yet
ingested into the atlas. See the Open Holes section below. [🤖]
...
- **Papers that use this method:** [[mathur_et_al_2018]], [[mcgrady_2023]], [[mcgrady_2025]], [[bartl_2018]]
